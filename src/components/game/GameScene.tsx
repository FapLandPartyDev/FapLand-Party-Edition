    ...
    <>
      ...
      <RoundVideoOverlay
        {...buildGameplayRoundVideoOverlayProps({
          ...
          disableInterjectionsDuringCumRounds: state.config.disableInterjectionsDuringCumRounds,
          allowPausingDuringFinalCumRound: state.config.allowPausingDuringFinalCumRound,
