...
export const THEHANDY_FUNSCRIPT_RATE_LIMIT_STORE_KEY = "thehandy.funscriptRateLimitEnabled";
export const INTIFACE_FUNSCRIPT_RATE_LIMIT_STORE_KEY = "intiface.funscriptRateLimitEnabled";
export const THEHANDY_FUNSCRIPT_MAX_RATE_STORE_KEY = "thehandy.funscriptMaxRate";
export const INTIFACE_FUNSCRIPT_MAX_RATE_STORE_KEY = "intiface.funscriptMaxRate";
export const THEHANDY_FUNSCRIPT_RDP_EPSILON_STORE_KEY = "thehandy.funscriptRdpEpsilon";
export const INTIFACE_FUNSCRIPT_RDP_EPSILON_STORE_KEY = "intiface.funscriptRdpEpsilon";
export const DEFAULT_FUNSCRIPT_RATE_LIMIT_ENABLED = true;
