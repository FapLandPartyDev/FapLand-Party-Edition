    ...
    <div className="space-y-2 p-3">
      ...
      {validation.errors.map((entry, index) => (
        <div
          ...
          className="flex items-start gap-2 rounded-lg border border-rose-500/25 bg-rose-950/15 px-3 py-2"
        >
      ...
      {validation.warnings.map((entry, index) => (
        <div
          ...
          className="flex items-start gap-2 rounded-lg border border-amber-500/25 bg-amber-950/15 px-3 py-2"
        >
