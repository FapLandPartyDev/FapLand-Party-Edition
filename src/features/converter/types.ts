...
export function segmentsOverlap(
  a: Pick<SegmentDraft, "startTimeMs" | "endTimeMs">,
  b: Pick<SegmentDraft, "startTimeMs" | "endTimeMs">
): boolean {
  return a.startTimeMs < b.endTimeMs && b.startTimeMs < a.endTimeMs;
}

export function assignSegmentLanes(
  segments: SegmentDraft[]
): Array<{ segment: SegmentDraft; lane: number }> {
